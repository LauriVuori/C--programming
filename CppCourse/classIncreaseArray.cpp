...
The member variables of the class should be: name, id, job, and salary. Define constructors with 
different set of parameters as well as the default constructor for the class. Define also search(), update() 
